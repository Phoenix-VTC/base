            ...
            <form wire:submit.prevent="submit">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="password" name="password" id="password" type="password" minlength="8" required
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="passwordConfirmation" name="password_confirmation"
                               id="password_confirmation" type="password" minlength="8"
