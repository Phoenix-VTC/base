                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <input type="text" name="username" id="username" autocomplete="username"
                               ...
                               class="mt-1 w-full shadow-sm sm:text-sm border border-gray-300 rounded-md">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <fieldset class="col-span-6 sm:col-span-4">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="flex items-center">
                                <input id="games_ets2" name="games" type="radio" value="1"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input id="games_ats" name="games" type="radio" value="0"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input id="games_both" name="games" type="radio" value="0"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                    ...
                    <fieldset class="col-span-6 sm:col-span-4">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="flex items-center">
                                <input id="fluent_yes" name="fluent" type="radio" value="1"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input id="fluent_no" name="fluent" type="radio" value="0"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                    ...
                    <div class="col-span-6 sm:col-span-4" x-data="{aboutCount: 0}" x-init="aboutCount = $refs.about.value.length">
                        <label for="about" class="block text-sm font-medium text-gray-700">
                            Tell us a little bit about yourself
                        </label>
                        <div class="mt-1">
                            <textarea id="about" name="about" rows="3" x-ref="about" x-on:keyup="aboutCount = $refs.about.value.length"
                    ...
                    <div class="col-span-6 sm:col-span-4" x-data="{whyJoinCount: 0}" x-init="whyJoinCount = $refs.why_join.value.length">
                        <label for="why_join" class="block text-sm font-medium text-gray-700">
                            Why do you want to join?
                        </label>
                        <div class="mt-1">
                            <textarea id="why_join" name="why_join" rows="3" x-ref="why_join" x-on:keyup="whyJoinCount = $refs.why_join.value.length"
                                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                    ...
                    <fieldset class="col-span-6 sm:col-span-4">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="flex items-center">
                                <input id="terms_yes" name="terms" type="radio" value="1"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input id="terms_no" name="terms" type="radio" value="0"
                                       class="focus:ring-orange-500 h-4 w-4 text-orange-600 border border-gray-300">
                    ...
                    <div class="col-span-6 sm:col-span-4" x-data="{findUsCount: 0}" x-init="findUsCount = $refs.find_us.value.length">
                        <label for="find_us" class="block text-sm font-medium text-gray-700">
                            How did you find us?
                        </label>
                        <div class="mt-1">
                            <textarea id="find_us" name="find_us" x-ref="find_us" x-on:keyup="findUsCount = $refs.find_us.value.length"
                                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="TruckersMP, Discord advertisements, TruckersFM, etc"></textarea>
                        </div>
