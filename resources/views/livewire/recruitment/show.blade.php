...
<main class="py-10">
    ...
    <div
        ...
        {{-- TruckersMP History --}}
        <section aria-labelledby="tmp-history-title" class="lg:col-start-3 lg:col-span-1">
            <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6">
                <h2 id="tmp-history-title" class="text-lg font-medium text-gray-900">TruckersMP History</h2>
