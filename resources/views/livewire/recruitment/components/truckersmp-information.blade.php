<section aria-labelledby="tmp-information-title" class="lg:col-start-3 lg:col-span-1">
    <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6">
            ...
            <ul class="-mb-8">
                ...
                <li>
                    <div class="relative pb-8">
                        @isset($application->ban_history[0])
                ...
                {{-- Ban History --}}
                @foreach($application->ban_history as $ban)
                    <li>
                        <div class="relative pb-8">
                            @if(!$loop->last)
                                <span class="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200"
        ...
        <div class="mt-6 flex flex-col justify-stretch">
            <button type="button" wire:click="clearTMPData" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Refresh data
            </button>
        </div>
    </div>
